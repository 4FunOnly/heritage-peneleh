...
<body class="d-flex h-100 text-left text-bg-dark">
    <div class="cover-container d-flex w-100 h-100 mx-auto flex-column text-center">
        ...
        <div class="p-5 mb-4 bg-transparent"
            style="background-image: url('/images/index-headline.jpg'); background-size: cover; background-position: center;">
            ...
            <div class="col-md-6">
                <div
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        <h3 class="mb-0">Virtual Tour Wisata Peneleh</h3>
                        <p class="card-text mb-auto">Kawasan Peneleh, atau dikenal sebagai Peneleh Herritage adalah
                            salah satu kawasan wisata sejarah di Surabaya yang menyimpan jejak sejarah dari tiga zaman;
                            Majapahit, Kolonial Belanda, dan Pergerakan Nasional Indonesia. Peneleh Herritage menawarkan
                            pengalaman wisata yang unik dan edukatif bagi para pengunjungnya. Di sini, pengunujung dapat
                            belajar tentang sejarah panjang Surabaya dan peran penting kawasan Peneleh dalam perjalanan
                            bangsa Indonesia</p>
                    </div>
                </div>
            </div>
